...
namespace Muztorg {
	...
	/// <summary>
	/// Сводка для GuitarsSales_Report
	/// </summary>
	public ref class GuitarsSales_Report : public System::Windows::Forms::Form
	{
	public:
		GuitarsSales_Report(Unit<Guitar>* data)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(GuitarsSales_Report::typeid));
			...
			this->TitleLabel->Text = L"Продажи по товару";
			// 
			// pictureBox1
			// 
			...
			this->Name = L"GuitarsSales_Report";
			this->Text = L"Отчёт по продажам";
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &GuitarsSales_Report::GuitarsSales_Report_FormClosed);
			this->Load += gcnew System::EventHandler(this, &GuitarsSales_Report::GuitarsSales_Report_Load);
...
#pragma endregion
	...
	private: System::Void GuitarsSales_Report_Load(System::Object^ sender, System::EventArgs^ e);
	private: System::Void GuitarsSales_Report_FormClosed(System::Object^ sender, System::Windows::Forms::FormClosedEventArgs^ e);
};
}
