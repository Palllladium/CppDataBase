...
namespace Muztorg {
	...
	/// <summary>
	/// Сводка для StructOfSale
	/// </summary>
	public ref class StructOfSales : public System::Windows::Forms::Form
	{
	public:
		StructOfSales(Unit<Sale>* data)
		{
			InitializeComponent();
	...
	private:
		...
		Unit<Unit<StructOfSale>*>* CurrentPtr;
		List<Unit<StructOfSale>*>* CurrentList;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ToggleChanges->Click += gcnew System::EventHandler(this, &StructOfSales::ToggleChanges_Click);
			// 
			// Prev
			// 
			...
			this->Prev->Location = System::Drawing::Point(86, 178);
			this->Prev->Name = L"Prev";
			this->Prev->Size = System::Drawing::Size(114, 29);
			this->Prev->TabIndex = 39;
			this->Prev->Text = L"PREV";
			this->Prev->UseVisualStyleBackColor = false;
			this->Prev->Click += gcnew System::EventHandler(this, &StructOfSales::Prev_Click);
			// 
			// ToggleChangesOff
			// 
			...
			this->ToggleChangesOff->Click += gcnew System::EventHandler(this, &StructOfSales::ToggleChangesOff_Click);
			// 
			// Save
			// 
			...
			this->Save->Click += gcnew System::EventHandler(this, &StructOfSales::Save_Click);
			// 
			// Add
			// 
			...
			this->Add->Click += gcnew System::EventHandler(this, &StructOfSales::Add_Click);
			// 
			// Next
			// 
			...
			this->Next->Location = System::Drawing::Point(206, 178);
			this->Next->Name = L"Next";
			this->Next->Size = System::Drawing::Size(114, 29);
			this->Next->TabIndex = 34;
			this->Next->Text = L"NEXT";
			this->Next->UseVisualStyleBackColor = false;
			this->Next->Click += gcnew System::EventHandler(this, &StructOfSales::Next_Click);
			// 
			// Exit
			// 
			...
			this->Exit->Location = System::Drawing::Point(326, 178);
			this->Exit->Name = L"Exit";
			this->Exit->Size = System::Drawing::Size(114, 29);
			this->Exit->TabIndex = 33;
			this->Exit->Text = L"EXIT";
			this->Exit->UseVisualStyleBackColor = false;
			this->Exit->Click += gcnew System::EventHandler(this, &StructOfSales::Exit_Click);
			// 
			// label2
			// 
			...
			this->AmountBox->Location = System::Drawing::Point(125, 132);
			...
			this->AmountBox->TextChanged += gcnew System::EventHandler(this, &StructOfSales::Box_TextChanged);
			this->AmountBox->Enter += gcnew System::EventHandler(this, &StructOfSales::Box_Enter);
			this->AmountBox->Leave += gcnew System::EventHandler(this, &StructOfSales::Box_Leave);
			// 
			// TitleBox
			// 
			...
			this->ClientSize = System::Drawing::Size(538, 231);
			...
			this->Name = L"StructOfSales";
			this->Text = L"Структура продажи";
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &StructOfSales::StructOfSales_FormClosed);
			this->Load += gcnew System::EventHandler(this, &StructOfSales::StructOfSales_Load);
...
#pragma endregion
	...
	private: System::Void StructOfSales_Load(System::Object^ sender, System::EventArgs^ e);
	private: System::Void StructOfSales_FormClosed(System::Object^ sender, System::Windows::Forms::FormClosedEventArgs^ e);
