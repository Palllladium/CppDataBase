...
namespace Muztorg {
	...
	/// <sumOfSale>
	/// —водка дл€ SuppliesGuitar_Report
	/// </sumOfSale>
	public ref class SuppliesGuitar_Report : public System::Windows::Forms::Form
	{
	public:
		SuppliesGuitar_Report(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Text = L"SuppliesGuitar_Report";
