...
namespace Muztorg {
	...
	/// <summary>
	/// —водка дл€ EmployeesSupplies_Report
	/// </summary>
	public ref class EmployeesSupplies_Report : public System::Windows::Forms::Form
	{
	public:
		EmployeesSupplies_Report(Unit<Employee>* data)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(EmployeesSupplies_Report::typeid));
			...
			this->label1->Location = System::Drawing::Point(183, 20);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(386, 33);
			this->label1->TabIndex = 20;
			this->label1->Text = L"ќтчЄт по поставкам сотрудника";
			// 
			// NameBox
			// 
			...
			this->NameBox->Font = (gcnew System::Drawing::Font(L"Calibri", 18, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->NameBox->Location = System::Drawing::Point(125, 64);
			...
			this->Name = L"EmployeesSupplies_Report";
			this->Text = L"ќтчЄт по поставкам";
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &EmployeesSupplies_Report::EmployeesSupplies_Report_FormClosed);
			this->Load += gcnew System::EventHandler(this, &EmployeesSupplies_Report::EmployeesSupplies_Report_Load);
...
#pragma endregion
	private: System::Void EmployeesSupplies_Report_Load(System::Object^ sender, System::EventArgs^ e);
	private: System::Void EmployeesSupplies_Report_FormClosed(System::Object^ sender, System::Windows::Forms::FormClosedEventArgs^ e);
	};
}