...
namespace Muztorg {
	...
	/// <sumOfSale>
	/// —водка дл€ SuppliesEmployee_Report
	/// </sumOfSale>
	public ref class SuppliesEmployee_Report : public System::Windows::Forms::Form
	{
	public:
		SuppliesEmployee_Report(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Text = L"SuppliesEmployee_Report";
