...
namespace Muztorg {
	...
	/// <summary>
	/// —водка дл€ BuyersSales_Report
	/// </summary>
	public ref class BuyersSales_Report : public System::Windows::Forms::Form
	{
	public:
		BuyersSales_Report(Unit<Buyer>* data)
		{
			InitializeComponent();
			this->SearchedBuyer = data;
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(BuyersSales_Report::typeid));
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Calibri", 20.25F, System::Drawing::FontStyle::Bold));
			this->label1->ForeColor = System::Drawing::SystemColors::ActiveCaptionText;
			this->label1->Location = System::Drawing::Point(198, 20);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(338, 33);
			this->label1->TabIndex = 20;
			this->label1->Text = L"ќтчЄт по покупкам клиента";
			// 
			// NameBox
			// 
			...
			this->NameBox->Font = (gcnew System::Drawing::Font(L"Calibri", 18, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->NameBox->Location = System::Drawing::Point(112, 66);
			...
			this->Name = L"BuyersSales_Report";
			this->Text = L"ќтчЄт по продажам";
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &BuyersSales_Report::BuyersSales_Report_FormClosed);
			this->Load += gcnew System::EventHandler(this, &BuyersSales_Report::BuyersSales_Report_Load);
...
#pragma endregion
	private: System::Void BuyersSales_Report_Load(System::Object^ sender, System::EventArgs^ e);
	private: System::Void BuyersSales_Report_FormClosed(System::Object^ sender, System::Windows::Forms::FormClosedEventArgs^ e);
};
}